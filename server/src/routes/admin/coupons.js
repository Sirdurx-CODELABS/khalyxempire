...
router.post('/', async (req, res) => {
  const { code, type, value, minSubtotal, maxUses, expiresAt, isActive, categoryIds, productIds } = req.body;
...
router.patch('/:id', async (req, res) => {
  ...
  const fields = ['code', 'type', 'value', 'minSubtotal', 'maxUses', 'expiresAt', 'isActive', 'categoryIds', 'productIds'];
