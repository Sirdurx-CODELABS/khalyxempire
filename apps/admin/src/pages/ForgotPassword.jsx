...
export default function ForgotPassword() {
  ...
  const submit = async (e) => {
    ...
    setLoading(true);
    try {
      const { data } = await api.post('/auth/forgot-password', { email, app: 'admin' });
      setSent(data);
    } catch (err) {
    ...
    <AuthShell badge="Admin Portal" logoSrc={logoSrc}>
      {sent ? (
        ...
        <>
          ...
          <p className="auth-lead">Enter the email on your admin account. We will send a reset link if it matches.</p>
